                ...
                <div class="header-top-item">
                    <div class="header-top-left">
                        <ul>
                            ...
                            <li>
                                <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#d7bfb2bbbbb897bab2b3a4b2a1f9b4b8ba">
                                    <i class="icofont-ui-message"></i>
                                    <span class="__cf_email__" data-cfemail="86eee3eaeae9c6ebe3e2f5e3f0a8e5e9eb">[email&#160;protected]</span>
                                </a>
                            </li>
                            <li>
...
<div class="navbar-area sticky-top">
    ...
    <div class="mobile-nav">
        <a href="index.html" class="logo">
            <img src="{{asset('assets/front-end-assets')}}/assets/img/logo-two.png" alt="Logo">
        </a>
    </div>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-md navbar-light">
                <a class="navbar-brand" href="index.html">
                    <img src="{{asset('assets/front-end-assets')}}/assets/img/logo.png" alt="Logo">
                </a>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item">
                                    <a href="#" class="nav-link active">Home Page 3</a>
                                </li>
                                <li class="nav-item">
